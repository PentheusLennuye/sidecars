...
test_sidecars.py Copyright 2026 George Cummings
...
This test ensures that python unit testing works. Once the stub _sidecars.py_
file is modified, this test can be deleted.
"""

from unittest import TestCase
from sidecars import sidecars as t
